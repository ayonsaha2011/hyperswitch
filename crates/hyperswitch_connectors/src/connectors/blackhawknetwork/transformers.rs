...
pub struct BlackhawknetworkCard {
...
pub enum BlackhawknetworkPaymentStatus {
    Succeeded,
    Failed,
    #[default]
    Processing,
...
impl From<BlackhawknetworkPaymentStatus> for common_enums::AttemptStatus {
    fn from(item: BlackhawknetworkPaymentStatus) -> Self {
        match item {
            BlackhawknetworkPaymentStatus::Succeeded => Self::Charged,
            BlackhawknetworkPaymentStatus::Failed => Self::Failure,
            BlackhawknetworkPaymentStatus::Processing => Self::Authorizing,
        }
    }
}
...
pub struct BlackhawknetworkPaymentsResponse {
    status: BlackhawknetworkPaymentStatus,
    id: String,
}
